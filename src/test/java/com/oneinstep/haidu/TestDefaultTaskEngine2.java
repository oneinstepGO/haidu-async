...
class TestDefaultTaskEngine2 {
    ...
    public void init() {
        ...
        try {
            String demoConfigFilePath = "/config/demo.task.config2.json";
            valueStr = IOUtils.toString(Objects.requireNonNull(TestDefaultTaskEngine2.class.getResourceAsStream(demoConfigFilePath)), StandardCharsets.UTF_8);
        } catch (IOException e) {
