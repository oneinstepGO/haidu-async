...
public class TestDefaultTaskEngine {
    ...
    private static void assertResult(RequestContext requestContext) {
        ...
        Assert.assertEquals("result9998 数据不对", "[[[[DATA:1,DATA:2] -> DATA:1001] -> DATA:1003,[[DATA:1,DATA:2] -> DATA:1001,[DATA:1,DATA:2] -> DATA:1002] " +
                "-> DATA:1004,[[DATA:1,DATA:2] -> DATA:1002] -> DATA:1005] -> DATA:1006] -> DATA:9998", result9998.getData());
